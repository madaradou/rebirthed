...
typedef struct
{
    ...
    Mix_Chunk *btnHoverSndEffect, *btnClickSndEffect, *pausesndeffect;
...
typedef struct
{
    ///menu
    //bg
    Sprite menuMainBg, menuplaybg, menuoptionbg, pausebg;
    ...
    Sprite newgame_Btn, loadgame_Btn;
...
typedef struct 
{
    ...
    Button newgameBtn, loadgameBtn, closeBtn;
